...
namespace StringFormats
{
  public class Program
  {
    ...
    public static string FormatWithCulture(FormattableString format, CultureInfo culture)
    {
      return format.ToString(culture);
    }
    public static void FormattedStringDemo()
    {
      DateTime today = DateTime.Today;
      var usedCulture = new CultureInfo("cs-CZ"); // České CultureInfo
      ...
      Console.WriteLine(FormatWithCulture($"{day:d}", usedCulture));
